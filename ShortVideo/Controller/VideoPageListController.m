...
#import "VideoModel.h"
#import "VideoPageListController.h"
...
__weak VideoPageListCell *currentCell = nil;
@interface VideoPageListController () <UITableViewDelegate, UITableViewDataSource, UITableViewDataSourcePrefetching>
...
@property (nonatomic, weak) VideoPageListCell *lastCell;

@property (nonatomic, strong) NSMutableArray<ShortVideoModel *> *records;
@property (nonatomic, assign) BOOL isFirstLoad;
@property (nonatomic, assign) BOOL isHeaderRefresh;

@property (nonatomic, strong) NSMutableArray<VideoPageListCell *> *displayedCells;

@end

@implementation VideoPageListController
...
- (instancetype)init {
    ...
    if(self) {
        ...
        _currentIndex = 0;
        _displayedCells = [NSMutableArray<VideoPageListCell *> array];
...
- (void)loadData:(NSInteger)pageSize {
    ...
    [self loadWithRespones:[self getData] pageSize:pageSize];
}
...
- (void)setUpView {
    ...
    [self.tableView registerClass:VideoPageListCell.class forCellReuseIdentifier:kvideoListCell];
...
- (void)tableView:(UITableView *)tableView didEndDisplayingCell:(VideoPageListCell *)cell forRowAtIndexPath:(NSIndexPath*)indexPath {
...
- (VideoPageListCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    // 填充视频数据
    VideoPageListCell *cell = [tableView dequeueReusableCellWithIdentifier:kvideoListCell forIndexPath:indexPath];
    if (_isFirstLoad) {
...
- (void)tableView:(UITableView *)tableView willDisplayCell:(VideoPageListCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath {
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary<NSKeyValueChangeKey,id> *)change context:(void *)context {
    ...
    if ([keyPath isEqualToString:@"currentIndex"]) {
        ...
        _isCurPlayerPause = NO;
        //获取当前显示的cell
        VideoPageListCell *cell = [self.tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:_currentIndex inSection:0]];
        currentCell = cell;
...
- (void)applicationBecomeActive {
    VideoPageListCell *cell = [self.tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:self.currentIndex inSection:0]];
...
- (void)dealloc {
    ...
    NSArray<VideoPageListCell *> *cells = [_tableView visibleCells];
    for (VideoPageListCell *cell in cells) {
        [cell.playerView cancelLoading:nil];
    }
        ...
        @"data" : @{
            ...
            @"records" : @[
                ...
                @{
                    ...
                    @"contentLocation" : @"",
                    @"collectStatus" : @0,
                    @"contentDescription" : @"斗破苍穹 中国太空漫步第一人",
                    @"hxgxId" : @"ZY01010000002685",
                    @"picture" : @[
                        @{
                            @"picHeight" : @"",
                            @"picWidth" : @"",
                        ...
                        @{
                            ...
                            @"clientType" : @"mobile",
                            @"picType" : @"Horizontal",
                            @"picUrl" : @"https://pqnoss.kepuchina.cn/kepuyun/2023/04/08/18/1680858139867.png?838/598",
                        },
                        @{
                            @"picHeight" : @"",
                            @"picWidth" : @"",
                    ...
                    @"contentDetail" : @[
                        @{
                            @"expressionType" : @"h5",
                            @"contentDetailUrl" : @"https://dzzlgl-kp.cast.org.cn/detail?uuid=7043716559919288320",
                        },
                        @{
                            @"expressionType" : @"pc",
                            @"contentDetailUrl" : @"https://dzzlgl-kp.cast.org.cn/detail?uuid=7043716559919288320",
                        ...
                        @{
                            @"expressionType" : @"mobile",
                            @"contentDetailUrl" : @"https://pqnoss.kepuchina.cn/U21157305/videos/2023040717022632536563169063vf_hd.mp4",
                        },
                    ],
                    @"storeLink" : @"",
                    @"likeStatus" : @0,
                    @"highlightTitle" : @"",
                    @"contentPubTime" : @"2023-04-07 00:00:00",
                    @"children" : @"",
                    @"logoUrl" : @"",
                    @"followStatus" : @0,
                    @"contentStartTime" : @"",
                    ...
                    @"contentEndTime" : @"",
                    @"chineseName" : @"",
                    @"contentId" : @"kp-article-7043716559919288320",
                    @"commentCount" : @"0",
                    @"contentTitle" : @"斗破苍穹 中国太空漫步第一人",
                    @"pubSource" : @[
                        @{
                            @"sourceName" : @"电子资源上报",
                            @"sourceType" : @"org",
