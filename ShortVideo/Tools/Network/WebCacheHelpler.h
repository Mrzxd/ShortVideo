...
@property (strong, nonatomic) NSURLSessionDataTask *dataTask; // 断点下载
...
@property (nonatomic, strong) WebCombineOperation  *currentCombineOperation;
@property (nonatomic, weak) AVPlayerView *playerView;
